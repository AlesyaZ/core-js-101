 ...
 *   getPolynom()      => null
 */
function getPolynom(...elem) {
  return function polynomialDef(i) {
    switch (elem.length) {
      case 3:
        return elem[0] * (i ** 2) + elem[1] * i + elem[2];
      case 2:
        return elem[0] * i + elem[1];
      case 1:
        return elem[0];
      default:
        return null;
